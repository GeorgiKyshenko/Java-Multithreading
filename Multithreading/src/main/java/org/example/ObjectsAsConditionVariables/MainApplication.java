package org.example.ObjectsAsConditionVariables;
...
public class MainApplication {
    private static final String INPUT_FILE = "D:\\_01.SoftServe Udemy Courses\\Java Multithreading\\Multithreading\\out\\matrices";
    private static final String OUTPUT_FILE = "D:\\_01.SoftServe Udemy Courses\\Java Multithreading\\Multithreading\\out\\matrices_results.txt";
    ...
    private static class ThreadSafeQueue {
        ...
        public synchronized void add(MatricesPair matricesPair) {
            //this is used in case in the input stream is coming from a bigger file (such as network stream) our application could run out of memory and crash
            //we absolutely need to apply backpressure on our producer for the que size to stays stable
